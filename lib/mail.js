...
export async function sendOrderConfirmationEmail(email, firstName, orderId, total_amount, taxAmount, discountAmount, itemsWithDetails, shippingAddress) {
  try {
    await transporter.sendMail({
      from: process.env.EMAIL_USER,
      to: email,
...
export async function sendOrderStatusUpdateEmail(email, firstName, orderId, newStatus, totalAmount, taxAmount, discountAmount, itemsWithDetails, shippingAddress, trackingNumber, courierName, courierWebsite, orderDetails) {
  try {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="totals-summary text-right">
                ...
                <p><strong>Shipping:</strong> AED ${Number(orderDetails.shippingCost).toFixed(2)}</p>
