...
const brandHeader = `
  <div style="display:inline-flex; align-items:center; gap:14px; justify-content:center;">
    ...
    <div style="text-align:left; line-height:1.25;">
      <div style="font-size:20px; font-weight:900; letter-spacing:0.05em; color:${TEXT_DEEP}; text-transform:uppercase; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">NAYA</div>
      <div style="font-size:13px; font-style:italic; font-family:Georgia,'Times New Roman',serif; color:${TEXT_MID}; margin-top:1px;">Lumière Cosmetics</div>
    </div>
  </div>
`;
...
export async function sendOrderConfirmationEmail(email, firstName, orderId, total_amount, taxAmount, discountAmount, subtotal, shippingCost, itemsWithDetails, shippingAddress, giftWrapCost) {
  try {
    ...
    const content = `
        ...
        <p>Dear ${firstName}, your order <strong style="color:${TEXT_DEEP};">#${orderId}</strong> has been successfully placed. Our laboratory is now preparing your selection.</p>
        ...
        <div class="summary-box">
            ...
            ${discountAmount > 0 ? `<div class="summary-item" style="color:${LAV_DARK};font-weight:700;"><span>Discount</span><span>−AED ${Number(discountAmount).toFixed(2)}</span></div>` : ''}
    ...
    <div style="max-width:800px; margin:40px auto; background:#ffffff; border-radius:20px; overflow:hidden; border:1px solid rgba(216,180,254,0.35); box-shadow:0 8px 40px rgba(147,51,234,0.08);">
        ...
        <div style="padding:36px 40px 28px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid rgba(216,180,254,0.2);">
            <div style="display:inline-flex; align-items:center; gap:14px;">
                <img src="${LOGO_URL}" alt="Naya Lumière" style="height:42px; width:auto; display:block;">
                <div style="text-align:left; line-height:1.25;">
                    <div style="font-size:20px; font-weight:900; letter-spacing:0.05em; color:#3b0764; text-transform:uppercase;">NAYA</div>
                    <div style="font-size:13px; font-style:italic; font-family:Georgia,'Times New Roman',serif; color:#6b21a8;">Lumière Cosmetics</div>
                </div>
            </div>
