...
const brandHeader = `<table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td width="1" style="vertical-align:middle;padding-right:8px;white-space:nowrap;"><img src="${LOGO_URL}" alt="Naya Lumière" width="48" height="48" style="display:block;width:48px;height:48px;object-fit:contain;"></td><td style="vertical-align:middle;white-space:nowrap;"><div style="font-size:16px;font-weight:700;letter-spacing:0.06em;color:${C.text};font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-transform:uppercase;line-height:1;margin:0;padding:0;">NAYA LUMIÈRE</div><div style="font-size:9px;letter-spacing:0.32em;color:${C.sub};font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-transform:uppercase;margin:3px 0 0 0;padding:0;line-height:1;">COSMETICS</div></td></tr></table>`;
