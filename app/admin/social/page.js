                        ...
                        >
                            ...
                            <div className="aspect-square relative overflow-hidden rounded-t-[2rem]">
                                ...
                                {post.is_active === false && (
                                    <div className="absolute top-3 left-3 px-2 py-1 bg-red-500/90 backdrop-blur-sm text-white text-[8px] font-black tracking-widest uppercase rounded-full">
                                        Hidden
                                    </div>
                                )}
                ...
                <form onSubmit={handleSubmit} className="p-8 lg:p-12 space-y-10">
                    <div className="space-y-8">
                        ...
                        <div className="group">
                            ...
                            <div className="relative group/img aspect-square max-w-[300px] mx-auto bg-gray-50 rounded-2xl border-2 border-dashed border-gray-100 flex flex-col items-center justify-center overflow-hidden transition-all hover:bg-gray-100/50">
                                {imageFile ? (
                                    <img src={URL.createObjectURL(imageFile)} alt="Preview" className="w-full h-full object-cover" />
                                ) : editingPost?.image_url ? (
                                    <img src={editingPost.image_url} alt="Current" className="w-full h-full object-cover" />
                                ) : (
