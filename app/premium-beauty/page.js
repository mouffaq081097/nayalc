...
const PremiumBeautyPage = () => {
    const { products, categories, brands, loading } = useAppContext();
        ...
        <div className="bg-brand-secondary">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-serif font-bold text-brand-text">Premium Beauty Collection</h1>
                    <p className="text-brand-muted mt-2 max-w-2xl mx-auto">Discover our curated selection of high-performance products.</p>
                </div>
...
export default PremiumBeautyPage;
